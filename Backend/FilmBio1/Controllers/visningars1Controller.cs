...
{
    public class visningars1Controller : ApiController
    {
        private FilmenRegistreringEntities22 db = new FilmenRegistreringEntities22();

        // GET: api/visningars1
        public IQueryable<visningar> Getvisningar()
        {
            return db.visningar;
        }

        // GET: api/visningars1/5
